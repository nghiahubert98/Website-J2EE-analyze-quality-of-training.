...
public class DeleteSinhVienServlet extends HttpServlet {
    ...
    private static Logger LOG = Logger.getLogger(DeleteSinhVienServlet.class);
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if (ValidateUtils.canConvertToInt(req.getParameter("id"))) {
                ...
                // form request and perform delete sinh vien from database.
                int id = Integer.parseInt(req.getParameter("id"));
                SinhVienBUS.getInstance().delete(id);
            ...
            LOG.error("Could not delete sinh vien which id is " + req.getParameter("id"), ex);
