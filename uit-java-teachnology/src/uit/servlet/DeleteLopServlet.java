...
@WebServlet("/lop-delete")
public class DeleteLopServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private static Logger LOG = Logger.getLogger(DeleteLopServlet.class);
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if (ValidateUtils.canConvertToInt(req.getParameter("id"))) {
                ...
                // form request and perform delete lop from database.
                int id = Integer.parseInt(req.getParameter("id"));
                LopBUS.getInstance().delete(id);
            ...
            LOG.error("Could not delete lop which id is " + req.getParameter("id"), ex);
