             ...
             <div class="card card-primary">
                <div class="card-header">
                  ...
                  <div class="ml-auto">
                      <a class="btn btn-white rounded btn-lg btn-icon icon-left"
                         href="<%= pathWebcontent %>/giang-vien?page=${backPage}">
                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <form action="<%= pathWebcontent %>/giangvien-edit?page=${backPage}" method="POST">
                          <input type="hidden" name="id" value="${data.id}">
                          <c:set value="${data.id}" var="idEdit"/>
                          <div class="form-group">
                            <label>Mã giảng viên</label>
                            <input type="text" name="code" class="form-control" 
                             value="${not empty error ? oldData.code: data.code}">
