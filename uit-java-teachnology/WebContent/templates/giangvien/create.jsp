        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="<%= pathWebcontent %>/giang-vien">Giảng viên</a></div>
                <div class="breadcrumb-item">Tạo Giảng viên</div>
            </div> 
          </div>    
                ...
                <div class="card-header">
                  ...
                  <div class="ml-auto">
                      <a class="btn btn-white rounded btn-lg btn-icon icon-left"
                         href="<%= pathWebcontent %>/giang-vien">
                ...
                <div class="card-body">
                    <div class="row">
                     ...
                     <jsp:include page="../fragments/message.jsp"></jsp:include>
                      ...
                      <div class="col-md-6">
                        <form action="<%= pathWebcontent %>/giangvien-create" method="POST" class="needs-validation" novalidate>
                        
                          <div class="form-group">
                            <label>Mã giảng viên</label>
                            <input type="text" name="code" class="form-control" 
                            required
                             value="${not empty error ? oldData.code: ''}">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control"
                             value="${not empty error ? oldData.email: ''}" required>
                             <div class="invalid-feedback">
                              Không được để trống trường này
                             </div>
                            <c:if test="${not empty error}">
                                <c:if test='${not empty error["email"] }'>
                                    <label class="text-danger">${error["email"] }</label>
                                </c:if>
                             </c:if>
                          </div>
