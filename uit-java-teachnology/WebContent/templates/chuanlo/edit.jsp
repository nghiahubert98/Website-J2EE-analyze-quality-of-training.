                ...
                <div class="card-header">
                  ...
                  <div class="ml-auto">
                      <a class="btn btn-white rounded btn-lg btn-icon icon-left"
                         href="<%= pathWebcontent %>/chuan-lo?page=${backPage}">
                ...
                <div class="card-body">
                    <div class="row">
                     ...
                     <jsp:include page="../fragments/message.jsp"></jsp:include>
                      ...
                      <div class="col-md-6">
                        <form action="<%= pathWebcontent %>/lo-edit?page=${backPage}" method="POST" class="needs-validation" novalidate>
                          <input type="hidden" name="lo-id" value="${data.id}">
                          <div class="form-group">
                            <label>Mã LO</label>
                            <input type="text" name="code" class="form-control" 
                            required
                             value="${not empty error ? oldData.maLO: data.maLO}">
