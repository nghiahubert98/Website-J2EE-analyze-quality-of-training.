...
<body>
        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Lớp</div>
            </div> 
          </div>    
          ...
          <div class="section-body">
             <div class="card author-box card-primary">
                <div class="card-header">
                    ...
                    <div class="ml-auto">
                        ...
                        <button type="button" id="dropdownMenuButton"
                            ...
                            data-toggle="dropdown" title="Các thao tác với danh sách lớp"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-ellipsis-v"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right"  aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="<%= pathWebcontent %>/lop-create">Thêm mới</a>
                            <a class="dropdown-item" href="<%= pathWebcontent %>/lop-excel">Thêm bằng Excel</a>                        
                          </div>
                        </div>
                    </div>
                    </c:if>
                ...
                <div class="card-body table-responsive p-0">
                   <form method="get" action="<%=pathWebcontent%>/lop">
                     <table class="table table-striped">
                        ...
                        <tr class="bg-white border-bottom">
                               <td class="pr-0">
                                  <a style="width: 52px;" href="<%=pathWebcontent%>/lop" class="btn btn-sm btn-danger">Bỏ lọc</a>
                               </td>
                               <td><input id="maLop" name="maLop" class="form-control form-control-sm" type="text"></td>
                               <td><input id="hocKy" name="hocKy" class="form-control form-control-sm" type="text"></td>
                               <td><input id="monHoc" name="monHoc" class="form-control form-control-sm" type="text"></td>
                               <td><input id="giangVien" name="giangVien" class="form-control form-control-sm" type="text"></td>
                               <td>
                                  <button class="btn btn-primary btn-sm" type="submit">Lọc</button>                                  
                               </td>
                            </tr>
                             <c:set value="${(data.currentPage - 1) * data.limit}" var="index"></c:set>
                             <c:forEach items = "${data.items}"  var = "lop">
                                ...
                                <tr>
                                    ...
                                    <td>${lop.maLop}
                                        <div class="table-links">
                                             <a href="<%= pathWebcontent %>/lop-detail?lid=${lop.id}">Chi tiết lớp</a>
                                             <a href="<%= pathWebcontent %>/sinhvien?id=${lop.id}" style="margin-left: 10px">Danh sách SV</a>
                                         </div>
                                    </td>
                                    <td>${lop.hocKy}
                                    </td>
                                    ...
                                    <td>
                                        <c:if test="${loginedUser.roles.contains(ADMIN_ROLE)}">
                                            <a href="<%= pathWebcontent %>/lop-edit?id=${lop.id}&backPage=${data.currentPage}" 
                                                class="btn btn-primary btn-sm"  data-id="${lop.id} " >Sửa</a>
                                            <a href="#" class="btn btn-danger btn-sm btn-delete" 
                                               data-confirm="Xóa lớp?|Bạn thật sự muốn xóa lớp này không?" 
                                               data-confirm-yes="confirmDelete(${lop.id},this)"
                                            >Xóa</a>
                                        </c:if>
                                    </td>
                                </tr>
                              ...
                              <c:if test="${data.items.size() == 0}">
                                <tr>
                                    <td colspan="5" class="text-center">Không có lớp nào được tạo</td>
                                </tr>
                             </c:if>
                        </tbody>
                    </table>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Xảy ra lỗi, không thể xóa lớp này được.</p>
          </div>
     ...
     <div class="modal fade" tabindex="-1" role="dialog" id="successDeleteModal" aria-modal="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Đã thực hiện xóa lớp thành công</p>
          </div>
          <div class="modal-footer bg-whitesmoke br">
 ...
 <script src="<%= pathWebcontent %>/resources/js/Lop/index.js"></script>
</body>
</html>
