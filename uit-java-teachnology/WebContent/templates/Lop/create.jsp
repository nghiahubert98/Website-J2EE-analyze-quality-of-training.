        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Thêm lớp</div>
            </div> 
          </div>    
                ...
                <div class="card-body">
                    <div class="row">
                     ...
                     <jsp:include page="../fragments/message.jsp"></jsp:include>
                      ...
                      <div class="col-md-6">
                        <form action="<%= pathWebcontent %>/lop-create" method="POST" class="needs-validation" novalidate>
                        
                          <div class="form-group">
                            <label>Mã lớp</label>
                            <input type="text" name="maLop" class="form-control" 
                            required
                             value="${not empty error ? oldData.maLop : ''}">
                           ...
                           <div class="form-group">
                              ...
                              <input id="mhName" name="monhoc" value="${listMH.items[0].id}" type="hidden">
                          ...
                          <div class="form-group">
                              ...
                              <input id="gvName" name="giangvien" value="${listGV.items[0].id}" type="hidden">
