        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="<%= pathWebcontent %>/chuan-g">G</a></div>
                ...
                <div class="card-header">
                  ...
                  <div class="ml-auto">
                      <a class="btn btn-white rounded btn-lg btn-icon icon-left"
                         href="<%= pathWebcontent %>/chuan-g?page=${backPage}">
                ...
                <div class="card-body">
                    <div class="row">
                     ...
                     <jsp:include page="../fragments/message.jsp"></jsp:include>
                      ...
                      <div class="col-md-6">
                        <form action="<%= pathWebcontent %>/g-edit?page=${backPage}" method="POST" class="needs-validation" novalidate>
                          <input type="hidden" name="g-id" value="${data.id}">
                          <div class="form-group">
                            <label>Mã G</label>
                            <input type="text" name="code" class="form-control" 
                            required
                             value="${not empty error ? oldData.maG: data.maG}">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control"
                             value="${not empty error ? oldData.mota: data.mota}" required>
                             <div class="invalid-feedback">
                              Không được để trống trường này
                             </div>
                            <c:if test="${not empty error}">
                                <c:if test='${not empty error["description"] }'>
                                    <label class="text-danger">${error["description"] }</label>
                                </c:if>
                             </c:if>
                          </div>
