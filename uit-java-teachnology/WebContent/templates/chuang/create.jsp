        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Tạo G</div>
            </div> 
          </div>    
                ...
                <div class="card-body">
                    <div class="row">
                     ...
                     <jsp:include page="../fragments/message.jsp"></jsp:include>
                      ...
                      <div class="col-md-6">
                        <form action="<%= pathWebcontent %>/g-create" method="POST" class="needs-validation" novalidate>
                        
                          <div class="form-group">
                            <label>Mã G</label>
                            <input type="text" name="code" class="form-control" 
                            required
                             value="${not empty error ? oldData.maG: ''}">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control"
                             value="${not empty error ? oldData.mota: ''}" required>
                             <div class="invalid-feedback">
                              Không được để trống trường này
                             </div>
                            <c:if test="${not empty error}">
