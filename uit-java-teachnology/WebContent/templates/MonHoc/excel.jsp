...
<head>
  ...
  <title>Import môn học bằng excel</title>
  <!-- Template CSS -->
          ...
          <div class="section-body">
             <div class="card card-primary col-md-6 offset-md-3">
                <div class="card-header">
                  <h4>Nhập môn học mới bằng Excel</h4>     
                  <div class="ml-auto">
                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <form action="<%= pathWebcontent %>/monhoc-excel" 
                           ...
                           <div class="form-group">
                               ...
                               href="<%= pathWebcontent %>/resources/excel/MonHocImport.xls">
