...
<body>
        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Ngành</div>
            </div> 
          </div>    
                ...
                <div class="card-header">
                    ...
                    <div class="ml-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-right"  aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="<%= pathWebcontent %>/nganh-create">Thêm mới</a>
                            <a class="dropdown-item" href="<%= pathWebcontent %>/nganh-excel">Thêm bằng Excel</a>                        
                          </div>
                        </div>
                    </div>
                    </c:if>
                     ...
                     <table class="table table-striped">
                        ...
                        <tbody>
                        	<tr class="bg-white border-bottom">
                               ...
                               <td><input id="manganh" name="manganh" class="form-control form-control-sm" type="text"></td>
                            ...
                            <c:set value="${(data.currentPage - 1) * data.limit}" var="index"></c:set>
                             <c:forEach items = "${data.items}"  var = "nganh">
                                <tr>
                                    <td> 
                                    ...
                                    <td>${nganh.manganh}
                                        <div class="table-links">
                                             <a href="<%= pathWebcontent %>/chuan-lo?nganh-id=${nganh.id}&nganh-name=${nganh.name}">Xem chi tiết</a>
                                         </div>
                                    </td>
                                    <td>${nganh.name}</td>
                                    <td>
                                        <c:if test="${loginedUser.roles.contains(ADMIN_ROLE)}">
                                        <a href="<%= pathWebcontent %>/nganh-edit?id=${nganh.id}&backPage=${data.currentPage}" 
                                            class="btn btn-primary btn-sm"  data-id="${nganh.id}">Sửa</a>
                                        <a href="#" class="btn btn-danger btn-sm btn-delete" 
                                           data-confirm="Xóa Ngành?|Bạn thật sự muốn xóa ngành này không?" 
                                           data-confirm-yes="confirmDelete(${nganh.id},this)"
                                        >Xóa</a>
                                        </c:if>
                                    </td>
                                </tr>
                              ...
                              <c:if test="${data.items.size() == 0}">
                                <tr>
                                    <td colspan="4" class="text-center">Không có ngành nào được tạo</td>
                                </tr>
                             </c:if>
                        </tbody>
                    </table>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Xảy ra lỗi, không thể xóa ngành này được.</p>
          </div>
     ...
     <div class="modal fade" tabindex="-1" role="dialog" id="successDeleteModal" aria-modal="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Đã thực hiện xóa ngành thành công</p>
          </div>
          <div class="modal-footer bg-whitesmoke br">
 ...
 <script src="<%= pathWebcontent %>/resources/js/nganh/index.js"></script>
