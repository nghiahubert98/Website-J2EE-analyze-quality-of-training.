        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="<%= pathWebcontent %>/nganh">Ngành</a></div>
                <div class="breadcrumb-item">Tạo Ngành</div>
            </div> 
          </div>    
                ...
                <div class="card-body">
                    <div class="row">
                     ...
                     <jsp:include page="../fragments/message.jsp"></jsp:include>
                      ...
                      <div class="col-md-6">
                        <form action="<%= pathWebcontent %>/nganh-create" method="POST" class="needs-validation" novalidate>
                        
                          <div class="form-group">
                            <label>Mã Ngành</label>
                            <input type="text" name="ma_nganh" class="form-control"  required  
                                value="${not empty error ? oldData.manganh: ''}">
                            <div class="invalid-feedback"> Không được để trống trường này </div>
                             <c:if test="${not empty error}">
                                <c:if test='${not empty error["ma_nganh"] }'>
                                    <label class="text-danger">${error["ma_nganh"] }</label>
                                </c:if>
                             </c:if>
                          </div>
