          ...
          <div class="section-body">
             <div class="card card-primary">
                <div class="card-header">
                  <h4>Chỉnh sửa thông tin ngành</h4>     
                  <div class="ml-auto">
                      <a class="btn btn-white rounded btn-lg btn-icon icon-left"
                         href="<%= pathWebcontent %>/nganh?page=${backPage}">
                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <form action="<%= pathWebcontent %>/nganh-edit?page=${backPage}" method="POST">
                          <input type="hidden" name="id" value="${data.id}">
                          <div class="form-group">
                            <label>Mã Ngành</label>
                            <input type="text" name="ma_nganh" class="form-control" 
                             value="${not empty error ? oldData.manganh: data.manganh}">
