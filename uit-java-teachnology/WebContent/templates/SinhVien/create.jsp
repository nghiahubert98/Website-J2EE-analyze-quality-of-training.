                ...
                <div class="card-body">
                    <div class="row">
                     ...
                     <jsp:include page="../fragments/message.jsp"></jsp:include>
                      ...
                      <div class="col-md-6">
                        <form action="<%= pathWebcontent %>/sinhvien-create" method="POST" class="needs-validation" novalidate>
                        
                          <div class="form-group">
                            <label>Mã số sinh viên</label>
                            <input type="text" name="mssv" class="form-control" 
                            required
                             value="${not empty error ? oldData.mssv : ''}">
                           ...
                           <div class="form-group">
                              ...
                              <input id="LSHName" name="lopsinhhoat" value="${listLSH.items[0].id}" type="hidden">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="ten_sinhvien" class="form-control"
                             value="${not empty error ? oldData.ten : ''}" required>
                             <div class="invalid-feedback">
                              Không được để trống trường này
                             </div>
                            <c:if test="${not empty error}">
